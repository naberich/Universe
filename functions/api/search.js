...
任务：基于你的知识，对这个话题给出一份**完全中文**的综合解读。严格按以下 JSON 格式返回（不要加任何解释、不要用 markdown 代码块包裹）：

{
  "title": "一句话概括这个话题，20-30 字",
  "body": "详细解读，分 3-4 段，每段 2-3 句话。涵盖：\\n1. 话题当前状态 / 最新动态\\n2. 关键数字或事实\\n3. 背后的驱动因素或影响\\n4. 对用户可能的启发",
  "refs": [
...
【语言规范 - 必须严格遵守】
- title、body、refs 所有字段必须**全部用简体中文**撰写
- 如果涉及英文新闻源、公司名、人名，**翻译成中文**（如 Bloomberg → 彭博社，Reuters → 路透社，The Verge → The Verge / 科技媒体，Apple → 苹果，Sam Altman → 萨姆·奥特曼）
- 技术术语（AI、API、GPU 等）可以保留英文缩写，但要用中文解释
- 不要出现整句英文段落
